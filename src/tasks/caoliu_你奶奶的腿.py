...
def one_commit():
    commiter = AutoCommit("你奶奶的腿", "PHPSESSID=gao7idg2g2jgvdi4nms6m2fpss; 227c9_ck_info=/	; 227c9_winduser=UAABAAoEaABfDQVTVFJSCQEIV1QAAwBQB1EMDVVXVQFTAQIOUgMMPg==; 227c9_groupid=8; 227c9_lastvisit=0	1671438481	/index.php?")
