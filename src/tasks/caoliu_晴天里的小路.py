...
def one_commit():
    commiter = AutoCommit("晴天里的小路", "PHPSESSID=3p8a2tck3m4mp861o9a4ll2e7d; 227c9_ck_info=/	; 227c9_winduser=UAMIAQ0KaApYDFVUB1IEClQPVwBdUg0LBVIMC1EHBgNUWgBZXlYNPg==; 227c9_groupid=8; 227c9_lastvisit=0	1671520573	/index.php?")
    commiter.user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36"
    commiter.run()
