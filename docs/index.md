...
hero:
    name: 1024 Little God
    text: Learning is never a loss
...
features:
    - title: Loves Freedom
      details: Whether it's physical freedom or freedom of the soul, I haven't achieved it yet. My body is sold to the company, and my soul is still wandering. But I haven't given up—I'm still trying.
      icon: 🎨
    - title: Values Health
      details: Health is fundamental. Without it, everything is just empty talk. The moment you step into a hospital, your body and your wallet are no longer yours—they’ll be emptied sooner or later.
      icon: 🌈
    - title: Enjoys Life
    ...
    - title: Open Source Enthusiast
      ...
      icon: 🐙
    - title: Fruit King
      details: Fruits are the most delicious things in the world. When I was a child, our yard had peach, apricot, and plum trees. We used to sleep under them on summer nights—but those days are gone.
      icon: 🍎
    ...
    - title: Takes Photos
      ...
      icon: 📸
    - title: Makes Videos
      details: After PakePlus went viral, I realized many people don't like reading tutorials, so I started making videos. To my surprise, many people watched them—positive feedback is amazing.
      icon: 🎥
---
